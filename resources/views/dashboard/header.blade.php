...
<head>
    ...
    <link rel="stylesheet" href="{{asset('resources/assets/css/cs-skin-elastic.css')}}">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-male fa-lg"></i> Student</a>
                        <ul class="sub-menu children dropdown-menu">                            
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{route('student.create')}}">Add Student</a>
                            </li>
                            <li><i class="fa fa-id-badge"></i><a href="{{route('admin.student')}}">View Student</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-tasks fa-lg"></i> Notice Category</a>
                        <ul class="sub-menu children dropdown-menu">                            
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{route('notice-category.create')}}">Add Category</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{route('admin.notice-category')}}">View Category</a></li>
                        </ul>
                    </li>

                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-pencil fa-lg"></i> Notice</a>
                        <ul class="sub-menu children dropdown-menu">                            
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{route('notice.create')}}">Add Notice</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{route('admin.notice')}}">view Notice</a></li>
                        </ul>
                    </li>
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="./"><img src="{{asset('resources/images/logo.png')}}" alt="Logo"></a>
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{asset('resources/images/admin.jpg')}}" alt="User Avatar">
                        </a>
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a class="nav-link" href="javascript:void(0)" onclick="$('#logout-form').submit();"><i class="fa fa-power -off"></i>Logout</a>
                            @csrf
                        </div>
                    </div>
